          ...
          <div class="row">
            <div class="col-12 col-sm-6">
              ...
              <div class="col-12">
                ...
                ?>
                <img src="recursos/images/<?=$imagen?>" class="product-image" alt="Product Image">
              </div>
              <div class="col-12 product-image-thumbs">
                <?php 
                    if(is_array($imagenes['data']))
                    foreach ($imagenes['data'] as $img) { ?>
                <div class="product-image-thumb active"><img src="recursos/images/<?=$img['url']?>" alt="Product Image"></div>           
                <?php 
                    }
                ?>    
             </div>
            ...
            <div class="col-12 col-sm-6">
              ...
              <hr>
              <h4>Marca: <?=$data[0]['Descripcion']?></h4>
              <h4>Modelo: <?=$data[0]['Cantidad']?></h4>
              <hr>
